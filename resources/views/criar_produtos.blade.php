        ...
        <div class="container">
            ...
            <form class="form" action="{{ route('produtos.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-content">
                    <label for="username">Nome do Salgado</label>
                    <input type="text" id="nome" name="nome" placeholder="Digite o nome do salgado..." />
                    <a>Aqui vai a mensagem de erro....</a>
                </div>

                <div class="form-content">
                    <label for="email">Preco do Salgado</label>
                    <input type="number" id="number" name="preco" step="0.01" placeholder="Digite o seu preço do salgado..." />
                    <a>Aqui vai a mensagem de erro....</a>
                </div>
